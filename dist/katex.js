...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__symbols__ = __webpack_require__(19);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__units__ = __webpack_require__(20);
...
fontName, mode) {
    ...
    return {
        value: value,
        metrics: Object(__WEBPACK_IMPORTED_MODULE_3__fontMetrics__["b" /* getCharacterMetrics */])(value, fontName, mode)
    };
};
...
var mathDefault = function mathDefault(value, mode, options, classes, type) {
    if (type === "mathord") {
        ...
        if (font === "ams") {
            ...
            return makeSymbol(value, _fontName3, mode, options, classes.concat(_fontName3, options.fontWeight, options.fontShape));
        }
    } else {
...
var makeOrd = function makeOrd(group, options, type) {
    ...
    if (fontOrFamily) {
        ...
        if (lookupSymbol(value, _fontName4, mode).metrics) {
            return makeSymbol(value, _fontName4, mode, options, classes.concat(fontClasses));
        } else {
...
var retrieveBaseFontName = function retrieveBaseFontName(font) {
    ...
    switch (font) {
        ...
        case "texttt":
            ...
            break;
        default:
            // probably a font added by a plugin
            baseFontName = font;
    }
    return baseFontName;
};
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__symbols__ = __webpack_require__(19);
...
var getVariant = function getVariant(group, options) {
    ...
    if (Object(__WEBPACK_IMPORTED_MODULE_1__fontMetrics__["b" /* getCharacterMetrics */])(value, fontName, mode)) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__units__ = __webpack_require__(20);
...
var groupTypes = {
    ...
    mclass: function mclass(group, options) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Token__ = __webpack_require__(28);
...
var anchor = function () {
    ...
    __WEBPACK_IMPORTED_MODULE_3_babel_runtime_helpers_createClass___default()(anchor, [{
        ...
        value: function toMarkup() {
            ...
            // Add the href
            markup += " href=\"" + __WEBPACK_IMPORTED_MODULE_5__utils__["a" /* default */].escape(this.href) + "\"";
            // Add the class
            if (this.classes.length) {
...
var ruleSpan = function ruleSpan(className, lineThickness, options) {
    ...
    return __WEBPACK_IMPORTED_MODULE_2__buildCommon__["a" /* default */].makeSvgSpan([parentClass], [svgNode], options);
};
...
"use strict";
/* harmony export (immutable) */ __webpack_exports__["a"] = addFontMetrics;
/* harmony export (immutable) */ __webpack_exports__["b"] = getCharacterMetrics;
/* harmony export (immutable) */ __webpack_exports__["c"] = getFontMetrics;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__unicodeScripts__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__submodules_katex_fonts_fontMetricsData__ = __webpack_require__(60);
 ...
 */
function addFontMetrics(newMetrics) {
    metricMap = __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_object_assign___default()(metricMap, newMetrics);
}
// add the default font metrics
addFontMetrics(__WEBPACK_IMPORTED_MODULE_2__submodules_katex_fonts_fontMetricsData__["a" /* default */]);
...
function getCharacterMetrics(character, font, mode) {
    ...
    if (!metrics && mode === 'text') {
        ...
        // not its width.
        if (Object(__WEBPACK_IMPORTED_MODULE_1__unicodeScripts__["b" /* supportedCodepoint */])(ch)) {
...
var Settings = function Settings(options) {
    ...
    this.unicodeTextInMathMode = __WEBPACK_IMPORTED_MODULE_1__utils__["a" /* default */].deflt(options.unicodeTextInMathMode, false);
    ...
    __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default()(Options, [{
        ...
        value: function fontMetrics() {
            if (!this._fontMetrics) {
                this._fontMetrics = Object(__WEBPACK_IMPORTED_MODULE_2__fontMetrics__["c" /* getFontMetrics */])(this.size);
            }
...
var getMetrics = function getMetrics(symbol, font, mode) {
    ...
    var metrics = Object(__WEBPACK_IMPORTED_MODULE_4__fontMetrics__["b" /* getCharacterMetrics */])(replace || symbol, font, mode);
    if (!metrics) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__buildCommon__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__defineFunction__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mathMLTree__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils__ = __webpack_require__(5);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2_match_at__ = __webpack_require__(146);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__Token__ = __webpack_require__(28);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__src_fontMetrics__ = __webpack_require__(29);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_symbols__ = __webpack_require__(19);
...
/* harmony default export */ __webpack_exports__["a"] = ({
    ...
    */
    __addFontMetrics: __WEBPACK_IMPORTED_MODULE_5__src_fontMetrics__["a" /* addFontMetrics */],
    /*
     * adds a new symbol to internal symbols table
    */
    __defineSymbol: __WEBPACK_IMPORTED_MODULE_6__src_symbols__["b" /* defineSymbol */]
});
...
$export($export.S + $export.F * !__webpack_require__(24), 'Object', { defineProperty: __webpack_require__(15).f });
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__environments__ = __webpack_require__(143);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__MacroExpander__ = __webpack_require__(145);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__symbols__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__units__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__unicodeScripts__ = __webpack_require__(42);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__unicodeAccents__ = __webpack_require__(149);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__unicodeSymbols__ = __webpack_require__(150);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__Token__ = __webpack_require__(28);
...
var Parser = function () {
    ...
    __WEBPACK_IMPORTED_MODULE_1_babel_runtime_helpers_createClass___default()(Parser, [{
        ...
        value: function parseSymbol() {
            ...
            if (__WEBPACK_IMPORTED_MODULE_9__unicodeSymbols__["a" /* default */].hasOwnProperty(text[0]) && !__WEBPACK_IMPORTED_MODULE_5__symbols__["a" /* default */][this.mode][text[0]] && (this.settings.unicodeTextInMathMode || this.mode === "text")) {
            ...
            if (__WEBPACK_IMPORTED_MODULE_5__symbols__["a" /* default */][this.mode][text]) {
                if (this.mode === 'math' && __WEBPACK_IMPORTED_MODULE_5__symbols__["c" /* extraLatin */].indexOf(text) >= 0 && !this.settings.unicodeTextInMathMode) {
                    throw new __WEBPACK_IMPORTED_MODULE_11__ParseError__["a" /* default */]("Unicode text character " + text + " used in " + "math mode without unicodeTextInMathMode setting", nucleus);
                }
            ...
            } else if (Object(__WEBPACK_IMPORTED_MODULE_7__unicodeScripts__["b" /* supportedCodepoint */])(text.charCodeAt(0)) && (this.mode === "text" || this.settings.unicodeTextInMathMode)) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__ParseError__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__ParseNode__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__defineFunction__ = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__functions_math__ = __webpack_require__(119);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__functions_enclose__ = __webpack_require__(120);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__functions_overline__ = __webpack_require__(121);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__functions_underline__ = __webpack_require__(122);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__functions_rule__ = __webpack_require__(123);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__functions_kern__ = __webpack_require__(124);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__functions_phantom__ = __webpack_require__(125);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__functions_mod__ = __webpack_require__(126);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__functions_op__ = __webpack_require__(127);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_15__functions_operatorname__ = __webpack_require__(128);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16__functions_genfrac__ = __webpack_require__(129);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__functions_lap__ = __webpack_require__(130);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_18__functions_smash__ = __webpack_require__(131);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_19__functions_delimsizing__ = __webpack_require__(132);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__functions_sizing__ = __webpack_require__(61);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__functions_styling__ = __webpack_require__(133);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__functions_font__ = __webpack_require__(134);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__functions_accent__ = __webpack_require__(138);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__functions_accentunder__ = __webpack_require__(139);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__functions_verb__ = __webpack_require__(140);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__functions_href__ = __webpack_require__(141);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__functions_mathchoice__ = __webpack_require__(142);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__defineFunction__ = __webpack_require__(2);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__defineFunction__ = __webpack_require__(2);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__mathMLTree__ = __webpack_require__(1);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__units__ = __webpack_require__(20);
...
Object(__WEBPACK_IMPORTED_MODULE_1__defineFunction__["b" /* default */])({
    ...
    htmlBuilder: function htmlBuilder(group, options) {
        ...
        if (group.value.value.length > 0) {
            ...
            var temp = __WEBPACK_IMPORTED_MODULE_5__buildHTML__["a" /* buildExpression */](group.value.value, options.withFont("mathrm"), true);
    ...
    mathmlBuilder: function mathmlBuilder(group, options) {
        ...
        var output = [];
        if (group.value.value.length > 0) {
            var temp = __WEBPACK_IMPORTED_MODULE_6__buildMathML__["a" /* buildExpression */](group.value.value, options.withFont("mathrm"));
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__environments_array_js__ = __webpack_require__(144);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__units__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__utils__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__stretchy__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__Token__ = __webpack_require__(28);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__macros__ = __webpack_require__(147);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ParseError__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7_object_assign__ = __webpack_require__(148);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__symbols__ = __webpack_require__(19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__utils__ = __webpack_require__(5);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__Token__ = __webpack_require__(28);
